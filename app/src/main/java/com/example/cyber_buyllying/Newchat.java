...
public class Newchat extends Activity  implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setText(Homepage.name);
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Newchat.this); // Use the correct context here
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                if (chat.equalsIgnoreCase("")) {
                    ...
                    String q = "/chatnew?sender_id=" + sh.getString("log_id", "") + "&receiver_id=" + Homepage.loginid + "&chat=" + chat;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
    ...
    void getChats() {
        ...
        JsonReq JR = new JsonReq();
        JR.json_response = (JsonResponse) Newchat.this;
        String q = "/viewchat1?sender_id=" + sh.getString("log_id", "") + "&receiver_id=" + Homepage.loginid;
        q = q.replace(" ", "%20");
